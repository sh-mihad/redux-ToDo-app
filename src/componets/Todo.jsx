...
import cancelImage from '../assest/images/cancel.png'
import { useDispatch } from 'react-redux';
import { toggled,deletd,colorSelcted } from '../redux/todos/action';
...
const Todo = ({todo}) => {
    ...
    const handleDeletd =(todoId)=>{
       dispatch(deletd(todoId))
    } 

    const handleColorChange = (todoId,color)=>{
        dispatch(colorSelcted(todoId,color))
    }
